...
func newBank(db *gorm.DB, opts ...gen.DOOption) bank {
	...
	_bank.UUID = field.NewString(tableName, "uuid")
	...
	_bank.CompanyID = field.NewInt64(tableName, "company_id")
	_bank.Status = field.NewString(tableName, "status")
...
type IBankDo interface {
	...
	PaginateParty(partyType string, column string, value int64, query string, limit int, offset int, orderColumn string, order string, enabled string) (result []model.Bank, err error)
	CountPaginateParty(partyType string, column string, value int64, query string, enabled string) (result int64, err error)
	Paginate(column string, value int64, query string, limit int, offset int, orderColumn string, order string, enabled string) (result []model.Bank, err error)
...
func (b bankDo) InsertReference(party_id int64, reference_id int64) (err error) {
...
func (b bankDo) InsertActivity(party_id int64, profile_id int64, typeActivity string, data *string) (err error) {
	var params []interface{}
...
func (b bankDo) InsertParty(party_type_code string) (result int64, err error) {
	var params []interface{}
...
func (b bankDo) PaginateParty(partyType string, column string, value int64, query string, limit int, offset int, orderColumn string, order string, enabled string) (result []model.Bank, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	generateSQL.WriteString("SELECT r.* FROM banks as r inner join parties as p on p.id = r.id ")
...
//
// {{end}}
func (b bankDo) CountPaginateParty(partyType string, column string, value int64, query string, enabled string) (result int64, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	generateSQL.WriteString("SELECT count(*) FROM banks as r inner join parties as p on p.id = r.id ")
	var whereSQL0 strings.Builder
	params = append(params, value)
	params = append(params, partyType)
	whereSQL0.WriteString(b.Quote(column) + "=? and p.party_type_code = ? ")
...
// {{end}}
// LIMIT @limit OFFSET @offset;
func (b bankDo) Paginate(column string, value int64, query string, limit int, offset int, orderColumn string, order string, enabled string) (result []model.Bank, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	generateSQL.WriteString("SELECT r.* FROM banks as r ")
	var whereSQL0 strings.Builder
	if column != "" {
		params = append(params, value)
...
//
// {{end}}
func (b bankDo) CountPaginate(column string, value int64, query string, enabled string) (result int64, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	generateSQL.WriteString("SELECT count(*) FROM banks as r ")
	var whereSQL0 strings.Builder
	if column != "" {
		params = append(params, value)
		whereSQL0.WriteString(b.Quote(column) + "=? ")

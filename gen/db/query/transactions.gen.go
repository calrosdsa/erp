...
func newTransaction(db *gorm.DB, opts ...gen.DOOption) transaction {
	...
	_transaction.Datetime = field.NewTime(tableName, "datetime")
	_transaction.Amount = field.NewInt32(tableName, "amount")
	_transaction.Ledger = field.NewInt64(tableName, "ledger")
	_transaction.LedgerDr = field.NewInt64(tableName, "ledger_dr")
	_transaction.VoucherCode = field.NewString(tableName, "voucher_code")
	_transaction.VoucherType = field.NewString(tableName, "voucher_type")
	_transaction.VoucherSubtype = field.NewString(tableName, "voucher_subtype")
	_transaction.PartyID = field.NewInt64(tableName, "party_id")
...
func (t *transaction) updateTableName(table string) *transaction {
	...
	t.Datetime = field.NewTime(table, "datetime")
	t.Amount = field.NewInt32(table, "amount")
	t.Ledger = field.NewInt64(table, "ledger")
	t.LedgerDr = field.NewInt64(table, "ledger_dr")
...
func (t *transaction) fillFieldMap() {
	...
	t.fieldMap["ledger_dr"] = t.LedgerDr

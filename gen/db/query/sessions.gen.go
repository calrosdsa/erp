...
func newSession(db *gorm.DB, opts ...gen.DOOption) session {
	...
	_session.ImpersonatedBy = field.NewString(tableName, "impersonated_by")
	_session.ActiveCompanyID = field.NewInt64(tableName, "active_company_id")
...
func (s *session) updateTableName(table string) *session {
	...
	s.ImpersonatedBy = field.NewString(table, "impersonated_by")
	s.ActiveCompanyID = field.NewInt64(table, "active_company_id")
...
func (s *session) fillFieldMap() {
	...
	s.fieldMap["impersonated_by"] = s.ImpersonatedBy
	s.fieldMap["active_company_id"] = s.ActiveCompanyID
}

...
func newRole(db *gorm.DB, opts ...gen.DOOption) role {
	...
	_role.CompanyID = field.NewInt64(tableName, "company_id")
	_role.WorkspaceID = field.NewInt64(tableName, "workspace_id")
...
func (r *role) updateTableName(table string) *role {
	...
	r.WorkspaceID = field.NewInt64(table, "workspace_id")
...
func (r *role) fillFieldMap() {
	...
	r.fieldMap["workspace_id"] = r.WorkspaceID
}
...
type IRoleDo interface {
	...
	PaginateParty(partyType string, column string, value int64, query string, limit int, offset int, orderColumn string, order string, enabled string) (result []model.Role, err error)
	CountPaginateParty(partyType string, column string, value int64, query string, enabled string) (result int64, err error)
	Paginate(column string, value int64, query string, limit int, offset int, orderColumn string, order string, enabled string) (result []model.Role, err error)
...
func (r roleDo) InsertReference(party_id int64, reference_id int64) (err error) {
...
func (r roleDo) InsertActivity(party_id int64, profile_id int64, typeActivity string, data *string) (err error) {
	var params []interface{}
...
func (r roleDo) InsertParty(party_type_code string) (result int64, err error) {
	var params []interface{}
...
func (r roleDo) PaginateParty(partyType string, column string, value int64, query string, limit int, offset int, orderColumn string, order string, enabled string) (result []model.Role, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	generateSQL.WriteString("SELECT r.* FROM roles as r inner join parties as p on p.id = r.id ")
...
//
// {{end}}
func (r roleDo) CountPaginateParty(partyType string, column string, value int64, query string, enabled string) (result int64, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	generateSQL.WriteString("SELECT count(*) FROM roles as r inner join parties as p on p.id = r.id ")
	var whereSQL0 strings.Builder
	params = append(params, value)
	params = append(params, partyType)
	whereSQL0.WriteString(r.Quote(column) + "=? and p.party_type_code = ? ")
...
// {{end}}
// LIMIT @limit OFFSET @offset;
func (r roleDo) Paginate(column string, value int64, query string, limit int, offset int, orderColumn string, order string, enabled string) (result []model.Role, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	generateSQL.WriteString("SELECT r.* FROM roles as r ")
	var whereSQL0 strings.Builder
	if column != "" {
		params = append(params, value)
...
//
// {{end}}
func (r roleDo) CountPaginate(column string, value int64, query string, enabled string) (result int64, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	generateSQL.WriteString("SELECT count(*) FROM roles as r ")
	var whereSQL0 strings.Builder
	if column != "" {
		params = append(params, value)
		whereSQL0.WriteString(r.Quote(column) + "=? ")

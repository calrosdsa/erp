...
const (
	TransactionService_SaveTransaction_FullMethodName = "/erp.api_v1.TransactionService/SaveTransaction"
)
...
type TransactionServiceClient interface {
	SaveTransaction(ctx context.Context, in *TransactionLedger, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *transactionServiceClient) SaveTransaction(ctx context.Context, in *TransactionLedger, opts ...grpc.CallOption) (*empty.Empty, error) {
...
type TransactionServiceServer interface {
	SaveTransaction(context.Context, *TransactionLedger) (*empty.Empty, error)
...
func (UnimplementedTransactionServiceServer) SaveTransaction(context.Context, *TransactionLedger) (*empty.Empty, error) {
...
func _TransactionService_SaveTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionServiceServer).SaveTransaction(ctx, req.(*TransactionLedger))
	}
...
var TransactionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "erp.api_v1.TransactionService",

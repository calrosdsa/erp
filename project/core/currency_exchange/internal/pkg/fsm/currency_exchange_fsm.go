...
type currencyExchangeFsm struct{}

func NewCurrencyExchangeFsm() fsm.FsmState{
	return &currencyExchangeFsm{}
}
func (f *currencyExchangeFsm) NextState(state string,events []int32,args ...interface{})(string,error) {

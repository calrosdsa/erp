...
type customerFsm struct{}

func NewCustomerFsm() fsm.FsmState{
	return &customerFsm{}
}
func (f *customerFsm) NextState(state string,events []int32,args ...interface{})(string,error) {

...
type journalEntryFsm struct{}

func NewJournalEntryFsm() fsm.FsmState {
	return &journalEntryFsm{}
}

func (f *journalEntryFsm) NextState(state string, events []int32, args ...interface{}) (string, error) {

...
type cashOutflowFsm struct{}

func NewFsm() fsm.FsmState{
	return &cashOutflowFsm{}
}

func (f *cashOutflowFsm) NextState(state string,events []int32,args ...interface{})(string,error) {
	...
	stateMachine.LinkStates(draftState, cancellledState, cancel)

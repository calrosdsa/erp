...
type purchaseRecordFsm struct{}

func NewPurchaseRecordFsm() fsm.FsmState {
	return &purchaseRecordFsm{}
}

func (f *purchaseRecordFsm) NextState(state string, events []int32, args ...interface{}) (string, error) {

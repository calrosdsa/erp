...
type salesRecordFsm struct{}

func NewSalesRecordFsm() fsm.FsmState{
	return &salesRecordFsm{}
}

func (f *salesRecordFsm) NextState(state string,events []int32,args ...interface{})(string,error) {

...
type quotationFsm struct{}

func NewQuotationFsm() fsm.FsmState {
	return &quotationFsm{}
}

func (f *quotationFsm) NextState(state string, events []int32, args ...interface{}) (string, error) {
